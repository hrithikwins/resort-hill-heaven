        ...
        <div className="container">
            <div className="row justify-content-center">
                <div className="col-md-7 text-center">
                    ...
                    <h2 className="font-weight-bold text-black">Experience at Heaven hill Resort</h2>
                    <p className="mb-5">Some experiences are worth experiencing, we at Heaven Hill Resort aim at
                    providing our visitors the best
                    treatment we can ever give. A feel as comfortable and friendly like home.
                  </p>
                </div>
            </div>
            <div className="row">
